...
> A voluntary, binding self-commitment to absorb future cost
> for the sake of another’s becoming —
> across time, uncertainty, and asymmetry.
...
Covenant is not a mechanism for fairness.
It is a mechanism for **continuity under finitude**.
...
> Even if irreducible cost is absorbed once,
> **how does life continue without exhausting the absorbers?**

This is the **intergenerational problem**.

Covenant is the solution to that problem.

It is not required to *prove* the framework,
but it is required to make the framework **livable across time**.
...
Marriage is not introduced to fix sin.
It is introduced to make **finite love sustainable**.
...
> voluntary sacrifice + continuity + trust
...
> Covenant may require ultimate trust —
> but it must never annihilate the future it promises.

This does three things at once:

1. **Stops child sacrifice** as a legitimate form of devotion
2. **Separates sacrifice from destruction of descendants**
3. **Links covenant to trust rather than appeasement**

In other words:

> Covenant is introduced *exactly where sacrifice becomes dangerous*.

That is not pedagogical coincidence.
...
The Church is not a system.
It is a **covenantal body**.
...
Marriage is its first human-scale instantiation.
Family is its intergenerational test case.
The Church is its civilizational extension.
Christ is its ground and fulfillment.
