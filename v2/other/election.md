...
So election cannot be universal *at first* —
it must be particular **for the sake of the universal**.
...
Election is not “chosen instead of others”
but “chosen **for** others”
...
If election were explainable, it would become optimizable.
...
**Does election fit the framework?**
Yes — tightly.

**Does election introduce anything structurally new?**
No — it intensifies responsibility, it doesn’t change the rules.

**Does the Bible go further than the framework?**
Only in insisting that:
