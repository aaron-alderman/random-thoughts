...
- [server.js](server.js) is a tiny zero-dependency Node server.
- [public/app.js](public/app.js) uses browser audio APIs: `getUserMedia`, `AudioContext`, `OscillatorNode`, and `AnalyserNode`.
- [public/fft-heatmap-common.js](public/fft-heatmap-common.js) is the shared heatmap/display helper layer used by the main app and transient experiments.
...
- [public/transient-phase.html](public/transient-phase.html) is a separate experiment page for fixed-carrier phase-jump transient testing, with the heatmap y-axis representing phase jump in degrees.
...
- [public/transient-click-width.html](public/transient-click-width.html) sweeps click width, [public/transient-click-amplitude.html](public/transient-click-amplitude.html) sweeps click amplitude, [public/transient-click-count.html](public/transient-click-count.html) sweeps click count, and [public/transient-click-spacing.html](public/transient-click-spacing.html) sweeps click spacing.
...
- [public/tracked-response.html](public/tracked-response.html) sweeps the drive frequency and records the returned peak nearest that same frequency, charting both matched amplitude and full width at half maximum across the sweep.
- [public/tracked-response.html](public/tracked-response.html) also plots the signed peak offset, so you can see how far the matched return drifts away from the driven frequency across the sweep.
