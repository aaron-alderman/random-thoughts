...
1. `master-framework.md` - the project breakdown, claim taxonomy, and maturity rules.
2. `spin23-compendium.md` - the broad map of where the framework applies and where it does not.
