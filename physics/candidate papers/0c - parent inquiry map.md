...
- treat the remainder
  ...
  u^\perp
  $$
  as the real parent hidden geometry
...
The parent relation space
$$
(\mathbf{R}\oplus\mathbf{C}\oplus\mathbf{H}\oplus\mathbf{O})\otimes
(\mathbf{R}\oplus\mathbf{C}\oplus\mathbf{H}\oplus\mathbf{O})
$$
remains a very strong candidate architecture.
